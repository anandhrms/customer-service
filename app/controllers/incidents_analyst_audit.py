...
from app.repositories import IncidentsAnalystAuditRepository
...
class IncidentsAnalystAuditController(BaseController[Incidents_Analyst_Audit]):
    def __init__(self, audit_repository: IncidentsAnalystAuditRepository):
        super().__init__(model=Incidents_Analyst_Audit, repository=audit_repository)
        self.audit_repository = audit_repository

    async def get_audit_by_id(self, audit_id: int) -> Incidents_Analyst_Audit:
    ...
    async def register(self, register_audit_request: dict) -> Incidents_Analyst_Audit:
